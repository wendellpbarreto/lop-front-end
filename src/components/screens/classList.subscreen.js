...
const ClassListSubscreen = props => {
  ...
  useEffect(() => {
    if (list && list.classHasListQuestion.submissionDeadline) {
      setDateInput(
        moment(list.classHasListQuestion.submissionDeadline).format(
          'YYYY-MM-DD'
        )
      )
      setTimeInput(
        moment(list.classHasListQuestion.submissionDeadline).format('HH:mm')
      )
    } else {
      setDateInput('')
      setTimeInput('')
                      ...
                      <CardHead>
                        ...
                        <CardOptions>
                          <i
                            ...
                            data-target={'#collapse2' + i + (list && list.id)}
                            aria-expanded={false}
                          />
                        </CardOptions>
                      </CardHead>
                      ...
                      <CardFooter>
                        <div className="h-100 w-100 d-flex align-items-center justify-content-between">
                          ...
                          <div className="h-100 d-flex align-items-center">
                            {isStudent() ? (
                              <Link
                                to={`/aluno/turma/${props.match.params.idClass}/lista/${list.id}/exercicio/${question.id}`}
                              >
                                <button
                              ...
                              <>
                                <Link
                                  to={`/professor/turma/${props.match.params.idClass}/lista/${list.id}/exercicio/${question.id}`}
                                >
                                  <button
                                    className="btn btn-success mr-2"
                                    style={{ float: 'right' }}
                                  ...
                                  <>
                                    ...
                                    <div className="dropdown-menu dropdown-menu-demo">
                                      <Link
                                        ...
                                        to={`/professor/turma/${props.match.params.idClass}/lista/${list.id}/exercicio/${question.id}/submissoes`}
                                      >
                                        Ver última submissão dos alunos
                                      </Link>
                                      <Link
                                        className="dropdown-item"
                                        to={`/professor/turma/${props.match.params.idClass}/lista/${list.id}/exercicio/${question.id}/submissoes/plagio`}
                                      >
                                        Verificar Plágios
                                      </Link>
                                    </div>
