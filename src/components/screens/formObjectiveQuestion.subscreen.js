...
const FormObjectiveQuestionSubscreen = props => {
  ...
  useEffect(() => {
    if (infoObjectiveQuestion) {
      ...
      setSelectedTags(
        infoObjectiveQuestion.tags.map(tag => ({
          value: tag.id,
          label: tag.name
        }))
      )
  ...
  const handlesaveSubmitQuestion = useCallback(
    async e => {
      e.preventDefault()
      ...
      isCreated &&
        history.push('/professor/exercicios', {
          tab: 1
        })
    },
  ...
  const handleUpdateSubmitQuestion = useCallback(
    async e => {
      e.preventDefault()
      const { idObjectiveQuestion } = props.match.params
            ...
            <Row className="mb-4">
              <Col className="col-12">
                ...
                <Select
                  ...
                  onChange={newTagsOptions =>
                    setSelectedTags(newTagsOptions || [])
                  }
                />
              </Col>
            </Row>
            ...
            <table className="table ">
              <tbody>
                ...
                {alternatives.map((alternative, i) => (
                  <tr key={i} className="">
                    <td
                      className="h-100 w-100 d-flex justify-content-center align-items-center mb-2 table-info"
                        ...
                        <Col className="col-11">
                          <div className="h-100 w-100 d-flex justify-content-center align-items-center">
                            ...
                            <SunEditor
                              ...
                              class="olaola"
                              onChange={content =>
                                handleChangeContentEditor(content, i)
                              }
