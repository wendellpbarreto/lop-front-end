...
const LessonsSubScreenComponent = props => {
  const profile = useMemo(
    () => sessionStorage.getItem('user.profile').toLocaleLowerCase(),
    []
  )
  const email = useMemo(
    () => sessionStorage.getItem('user.email').toLocaleLowerCase(),
    []
  )
  ...
  const handleChangeVisibilityLesson = useCallback(
    async (e, idLesson) => {
    ...
    <>
      ...
      <Row className="mb-4">
        <Col className="col-3">
          {isAuthor() && (
            <Link
              to={`/professor/curso/${props.match.params.IdCourse}/criarAulas`}
            >
          ...
          <Card>
            ...
            >
              <div className="d-flex flex-column">
                ...
                {course.author && course.author.email && (
                        ...
                        <Card>
                          ...
                          >
                            ...
                            <CardOptions>
                              {isAuthor() && (
                                <Link
                                  to={`/professor/curso/${props.match.params.IdCourse}/editarAulas/${lesson.id}`}
                                >
                                  <IconButton
                              ...
                              {isAuthor() && (
                                <>
                                  <Switch
                                    ...
                                    onChange={e =>
                                      handleChangeVisibilityLesson(e, lesson.id)
                                    }
                                    color="primary"
                                    name="check"
                                    inputProps={{
