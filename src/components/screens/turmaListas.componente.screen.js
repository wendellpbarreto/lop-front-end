                ...
                <CardHead>
                  ...
                  <ProgressBar
                    ...
                    numQuestionsCompleted={
                      lista.questionsCompletedSumissionsCount
                    }
                  ...
                  <CardOptions>
                    {profile === 'aluno' ? (
                      ...
                      <Link
                        to={`/professor/turma/${props.match.params.id}/participantes/${user.id}/listas/${lista.id}/exercicios`}
                      >
                      ...
                      <>
                        <Link
                          to={`/professor/turma/${props.match.params.id}/lista/${lista.id}`}
                        >
                          <button className="btn btn-success mr-2">
                            Acessar <i className="fa fa-wpexplorer" />
                          </button>
